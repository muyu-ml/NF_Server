...
import com.lcl.ntf.api.user.request.condition.UserIdQueryCondition;
import com.lcl.ntf.api.user.request.condition.UserPhoneAndPasswordQueryCondition;
import com.lcl.ntf.api.user.request.condition.UserPhoneQueryCondition;
import com.lcl.ntf.api.user.request.condition.UserQueryCondition;
import lombok.*;
