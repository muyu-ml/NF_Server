package com.lcl.nft.chain.infrastructure.utils;

import cn.hutool.crypto.digest.DigestUtil;
import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONWriter;
import com.google.common.collect.Maps;
import com.lcl.nft.chain.domain.entity.RequestBody;
...
public class WenChangChainUtils {
     ...
     * @return 返回签名结果
     */
    public static String signRequest(String path, RequestBody body, long timestamp, String apiSecret) {
